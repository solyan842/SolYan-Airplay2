...
impl RtspSession {
    ...
    pub fn build_setup_phase1(
        ...
        self.build_setup_phase1_with_clock(local_timing_port, local_addresses, None)
    }

    /// Build SETUP phase 1 with an explicit PTP timeline ClockID.
    pub fn build_setup_phase1_with_clock(
        &self,
        local_timing_port: u16,
        local_addresses: Option<Vec<String>>,
        timing_clock_id: Option<u64>,
    ) -> Result<Vec<u8>> {
